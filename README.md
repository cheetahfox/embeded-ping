...
per second but keeping a rolling window of the last 15, 100 and 1000 packets to then calculate the network performnace.
This makes Long Ping very similar to running a standard `ping` to a host but it can track long term 
